...
.next_root_entry:
	...
	call stringCompare	    ; Current entry same as requested?
...
fileWrite:
	...
	call fileExists 	    ; Don't overwrite a file if it exists!
	jnc near .failure
...
.carry_on:
	...
	call fileCreate 	    ; Create empty root dir entry for this file
...
fileCreate:
	...
	call fileExists 	    ; Does the file already exist?
	jnc .exists_error
